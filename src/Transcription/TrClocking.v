...
Module Type TRCLOCKING
  ...
  Proof.
    ...
    - destruct o. cases; monadInv Htr.
      ...
      monadInv Htr'. take (LC.wc_exp _ _ _) and inv it.
      take (exists _,_) and destruct it as (bck & sub & WIi & WIo).
      ...
      + (* inputs *)
        ...
        assert (TODO := H1).
        take (to_lexp e = _) and eapply wc_lexp in it as (ck & Hck & Wce);
          eauto.
        ...
        simpl in *. rewrite H0. destruct nc as (ck & []).
        2:{ simpl.
        ...
        destruct e; take (LC.wc_exp G vars _) and inv it;
          inv Hcke; take (to_lexp _ = _) and inv it.
        constructor.
