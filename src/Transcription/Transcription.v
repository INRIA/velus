...
Module Type TRANSCRIPTION
  ...
  Declare Module Export Typing : TRTYPING Ids Op OpAux L.Syn L.Typ L.Norm.Norm CE.Syn CE.Typ NL.Syn NL.Ord NL.Typ Tr.
...
Module TranscriptionFun
  ...
  Module Export Typing := TrTypingFun Ids Op OpAux L.Syn L.Typ L.Norm.Norm CE.Syn CE.Typ NL.Syn NL.Ord NL.Typ Tr.
