...
Module Type TRANSCRIPTION
  ...
  Declare Module Export Correctness : CORRECTNESS Ids Op OpAux L.Syn CE.Syn NL.Syn Tr L.Typ L.Clo L.Cau NL.Ord L.Ord CStr IStr L.Sem L.ClSem NL.CoindSem.
...
Module TranscriptionFun
  ...
  Module Export Correctness := CorrectnessFun Ids Op OpAux L.Syn CE.Syn NL.Syn Tr L.Typ L.Clo L.Cau NL.Ord L.Ord CStr IStr L.Sem L.ClSem NL.CoindSem.
