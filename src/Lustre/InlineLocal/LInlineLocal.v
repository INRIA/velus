...
Module Type LINLINELOCAL
  ...
  Declare Module Export Correct : ILCORRECTNESS Ids Op OpAux Cks CStr Senv Syn Cau Typ Clo Ord Sem ClSem IL.
End LINLINELOCAL.
...
Module LInlineLocalFun
       ...
       (Sem : LSEMANTICS Ids Op OpAux Cks Senv Syn Ord CStr)
       (ClSem : LCLOCKSEMANTICS Ids Op OpAux Cks Senv Syn Typ Clo Cau Ord CStr Sem)
       <: LINLINELOCAL Ids Op OpAux Cks CStr Senv Syn Typ Clo Cau Ord Sem ClSem.
  ...
  Module Export Correct := ILCorrectnessFun Ids Op OpAux Cks CStr Senv Syn Cau Typ Clo Ord Sem ClSem IL.
End LInlineLocalFun.
