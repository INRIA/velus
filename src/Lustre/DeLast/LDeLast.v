...
Module Type LDELAST
  ...
  Declare Module Export DL : DELAST Ids Op OpAux Cks Syn.
  Declare Module Export Typing : DLTYPING Ids Op OpAux Cks Syn Typ DL.
  Declare Module Export Clocking : DLCLOCKING Ids Op OpAux Cks Syn Clo DL.
  Declare Module Export Correct : DLCORRECTNESS Ids Op OpAux Cks CStr Syn Cau Typ Clo Ord Sem ClSem DL.
End LDELAST.
...
Module LDeLastFun
       ...
       (Sem : LSEMANTICS Ids Op OpAux Cks Syn Ord CStr)
       (ClSem : LCLOCKSEMANTICS Ids Op OpAux Cks Syn Typ Clo Cau Ord CStr Sem)
       <: LDELAST Ids Op OpAux Cks CStr Syn Typ Clo Cau Ord Sem ClSem.
  Module Export DL := DeLastFun Ids Op OpAux Cks Syn.
  Module Export Typing := DLTypingFun Ids Op OpAux Cks Syn Typ DL.
  Module Export Clocking := DLClockingFun Ids Op OpAux Cks Syn Clo DL.
  Module Export Correct := DLCorrectnessFun Ids Op OpAux Cks CStr Syn Cau Typ Clo Ord Sem ClSem DL.
End LDeLastFun.
