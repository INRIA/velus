...
Module Type LDENOT
    ...
    Declare Module Export Restr : LRESTR     Ids Op OpAux Cks Senv Syn.
    Declare Module Export Inf   : LDENOTINF  Ids Op OpAux Cks Senv Syn Typ Caus Lord Restr Sd.
    Declare Module Export CheckOp  : CHECKOP       Ids Op OpAux Cks Senv Syn.
...
Module LdenotFun
       ...
       (Str   : COINDSTREAMS  Ids Op OpAux Cks)
       (Sem   : LSEMANTICS Ids Op OpAux Cks Senv Syn Lord Str)
<: LDENOT Ids Op OpAux Cks Senv Syn Typ Cl Caus Lord Str Sem.
  Module Export Sd := SdFun Ids Op OpAux Cks Senv Syn Lord.
  Module Export Restr := RestrFun  Ids Op OpAux Cks Senv Syn.
  Module Export Inf := LDenotInfFun Ids Op OpAux Cks Senv Syn Typ Caus Lord Restr Sd.
  Module Export CheckOp := CheckOpFun Ids Op OpAux Cks Senv Syn.
