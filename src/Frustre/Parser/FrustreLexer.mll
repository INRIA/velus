...
rule initial = parse
  ...
  | "//"                          { singleline_comment lexbuf; initial lexbuf }
  | "--"                          { singleline_comment lexbuf; initial lexbuf }
  | integer_constant as s         { CONSTANT (FrustreAst.CONST_INT s,
                                                    currentLoc lexbuf) }
  | decimal_floating_constant     { CONSTANT (FrustreAst.CONST_FLOAT
                                      ...
                                      currentLoc lexbuf) }
  | hexadecimal_floating_constant { CONSTANT (FrustreAst.CONST_FLOAT
