...
From Velus Require Export NLustre.NLSemanticsCoInd.
...
From Velus Require Export Streams.
...
Module Type NLUSTRE
  ...
  Declare Module Export CloSem     : NLCLOCKINGSEMANTICS  Ids Op OpAux CE.Syn Syn Str Ord CE.Sem Sem Mem IsD CE.IsF IsF CE.Clo Clo CE.CloSem.
...
Module NLustreFun
       ...
       (Str   : STREAM        Op OpAux)
       (CE    : COREEXPR Ids  Op OpAux Str)
<: NLUSTRE Ids Op OpAux Strs Str CE.
  ...
  Module Export CloSem     := NLClockingSemanticsFun  Ids Op OpAux CE.Syn Syn Str Ord CE.Sem Sem Mem IsD CE.IsF IsF CE.Clo Clo CE.CloSem.
