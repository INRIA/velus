...
Module Type NLUSTRE
  ...
  Declare Module Export CoindToIdx : NLCOINDTOINDEXED     Ids Op OpAux CE.Syn Syn IStr CStr Ord CE.Sem Sem CoindSem.
  Declare Module Export Typ        : NLTYPING             Ids Op       CE.Syn Syn      Ord CE.Typ.
  Declare Module Export Norm       : NLNORMALARGS         Ids Op       CE.Syn CE.Typ Syn Ord Typ.
...
Module NLustreFun
       ...
       (IStr  : INDEXEDSTREAMS Op OpAux)
       (CE    : COREEXPR Ids   Op OpAux IStr)
<: NLUSTRE Ids Op OpAux CStr IStr CE.
  ...
  Module Export CoindToIdx := NLCoindToIndexedFun     Ids Op OpAux CE.Syn Syn IStr CStr Ord CE.Sem Sem CoindSem.
  Module Export Typ        := NLTypingFun             Ids Op       CE.Syn Syn     Ord CE.Typ.
  Module Export Norm       := NLNormalArgsFun         Ids Op       CE.Syn CE.Typ Syn Ord Typ.
