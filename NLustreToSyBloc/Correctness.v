...
Module Type CORRECTNESS
  ...
  Section Global.
    ...
    Section SemInstant.
      ...
      (* Proof. *)
      (*   induction 1; simpl; intros Nmv; eauto using SemSB.sem_lexp_instant. *)
      (*   - do 2 constructor. *)
      (*     match goal with H: SemSB.sem_mem_var_instant _ _ _ |- _ => inv H end. *)
      (*     unfold SemSB.get_mem in *. *)
      ...
      (* Proof. *)
      (*   induction 1; simpl; intros Nmv; eauto using SemSB.sem_cexp_instant. *)
      (*   - econstructor; eauto. *)
    ...
    Section Sem.
      ...
      (*     Forall (SemSB.sem_equation P k bk H M mems) eqs -> *)
      (*     Forall (SemSB.sem_equation P k bk H (madd_mem x mvs M) mems) eqs. *)
      (* Proof. *)
      (*   intros ** (* Hnd *) Hsem. *)
