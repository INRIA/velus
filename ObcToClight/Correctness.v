...
Section PRESERVATION.
  ...
  Proof.
    ...
    - (* get the Clight corresponding function *)
      ...
      + assert (ys = []) as Hys by (apply length_nil; rewrite Hys_out; auto).
      ...
      + admit.
      + (* the *out parameter *)
        assert (1 < length ys)%nat as Hys by (rewrite Hys_out; simpl; omega).
