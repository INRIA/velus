...
Module Type DATAFLOW (Op: OPERATORS).
  ...
  Declare Module Export Sem: SEMANTICS Op Syn Str Ord.
  ...
  Declare Module Export MemSem: MEMSEMANTICS Op Syn Str Ord Mem IsF IsD Sem IsV NoD WeF.     
